  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
      ...
      <p className="text-sm text-gray-600 mt-2">
        Compila questi campi solo se hai bisogno di fattura con dati specifici
      </p>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-blue-700">
                  <strong>Nota:</strong> I dati di fatturazione sono completamente facoltativi. 
                  Se non compili nessun campo, la fattura sarà intestata ai dati dell&apos;azienda standard.
                </p>
              </div>
            </div>
          </div>
