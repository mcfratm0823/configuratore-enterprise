              ...
              <div className="space-y-8">
                <div>
                  <h2 className="text-[#171717] text-base md:text-lg lg:text-xl xl:text-2xl font-normal leading-relaxed mb-6">
                    La tua richiesta di preventivo <span className="text-[#ed6d23] font-medium">{isPrivateLabel ? 'Private Label' : 'White Label'}</span> è stata inviata con successo.
                  </h2>
                ...
                <div className="bg-white rounded-lg p-6 md:p-8 border border-gray-200">
                  <h3 className="text-lg md:text-xl font-medium text-[#171717] mb-4">Cosa succede ora?</h3>
                  <div className="space-y-3">
                    {isPrivateLabel ? (
                      <>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-[#ed6d23] rounded-full mt-2 flex-shrink-0"></div>
                          <p className="text-gray-600 text-sm md:text-base">Analizzeremo la tua richiesta di bevanda personalizzata</p>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-[#ed6d23] rounded-full mt-2 flex-shrink-0"></div>
                          <p className="text-gray-600 text-sm md:text-base">Ti contatteremo entro 24 ore per un colloquio tecnico</p>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-[#ed6d23] rounded-full mt-2 flex-shrink-0"></div>
                          <p className="text-gray-600 text-sm md:text-base">Prepareremo un preventivo dettagliato per il tuo progetto</p>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-[#ed6d23] rounded-full mt-2 flex-shrink-0"></div>
                          <p className="text-gray-600 text-sm md:text-base">Discuteremo tempi di sviluppo e produzione</p>
                        </div>
                      </>
                    ) : (
                      <>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-[#ed6d23] rounded-full mt-2 flex-shrink-0"></div>
                          <p className="text-gray-600 text-sm md:text-base">Riceverai una email di conferma a breve</p>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-[#ed6d23] rounded-full mt-2 flex-shrink-0"></div>
                          <p className="text-gray-600 text-sm md:text-base">Analizzeremo la tua richiesta entro 24 ore</p>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-[#ed6d23] rounded-full mt-2 flex-shrink-0"></div>
                          <p className="text-gray-600 text-sm md:text-base">Ti invieremo un preventivo dettagliato personalizzato</p>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-[#ed6d23] rounded-full mt-2 flex-shrink-0"></div>
                          <p className="text-gray-600 text-sm md:text-base">Un nostro esperto ti contatterà per finalizzare</p>
                        </div>
                      </>
                    )}
                  </div>
                ...
                <div className="bg-white rounded-lg p-6 md:p-8 border border-gray-200">
                  <h3 className="text-lg md:text-xl font-medium text-[#171717] mb-3">Controlla la tua email</h3>
                  <p className="text-gray-600 text-sm md:text-base">
                    Ti abbiamo inviato una conferma con tutti i dettagli della tua richiesta.
                  </p>
                </div>
