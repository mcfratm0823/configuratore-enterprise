        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-0">
          <div className="space-y-6 lg:grid lg:grid-cols-12 lg:gap-16 lg:items-start lg:space-y-0">
            ...
            <div className="lg:col-span-5">
              <h1 className="text-[#171717] leading-tight text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-normal mb-3 md:mb-4">
                Campione <span className="text-[#ed6d23] font-medium">White Label</span> ordinato
              </h1>
            ...
            <div className="lg:col-span-6">
              <div className="space-y-6 md:space-y-8">
                ...
                <div className="mb-4">
                  <h3 className="text-lg md:text-xl font-medium text-[#171717] mb-6">Prossimi passi</h3>
                    ...
                    <div className="space-y-4 md:space-y-5">
                      <div className="relative flex items-start gap-4">
                        ...
                        <div className="flex-1 pt-0.5">
                          <h4 className="text-[#171717] text-sm md:text-base font-medium mb-1">Conferma email</h4>
                          <p className="text-gray-600 text-xs md:text-sm leading-relaxed">Riceverai una email di conferma con tutti i dettagli</p>
                        </div>
                      </div>
                      ...
                      <div className="relative flex items-start gap-4">
                        ...
                        <div className="flex-1 pt-0.5">
                          <h4 className="text-[#171717] text-sm md:text-base font-medium mb-1">Preparazione campione</h4>
                          <p className="text-gray-600 text-xs md:text-sm leading-relaxed">Il campione verrà preparato entro 2-3 giorni lavorativi</p>
                        </div>
                      </div>
                      ...
                      <div className="relative flex items-start gap-4">
                        ...
                        <div className="flex-1 pt-0.5">
                          <h4 className="text-[#171717] text-sm md:text-base font-medium mb-1">Spedizione tracciata</h4>
                          <p className="text-gray-600 text-xs md:text-sm leading-relaxed">Ti invieremo il codice di tracking per la spedizione</p>
                        </div>
                      </div>
                      ...
                      <div className="relative flex items-start gap-4">
                        ...
                        <div className="flex-1 pt-0.5">
                          ...
                          <p className="text-gray-600 text-xs md:text-sm leading-relaxed">Il team ti contatterà per discutere il preventivo</p>
                        </div>
                      </div>
                    </div>
                  </div>
